...
CHECKPOINT_FILE = "/srv/share2/aahluwalia30/polygen/lightning_logs/version_491089/checkpoints/trained_vertex_model.ckpt"
...
def sample_from_vertex_model(
    ...
    with torch.no_grad():
        vertex_samples = vertex_model.sample(
            context=context, num_samples=num_samples, only_return_complete=False, max_sample_length=150
        )
...
if __name__ == "__main__":
    pdb.set_trace()
    vertex_model_config = load_config(config_name="vertex_model_config_1231.yaml", vertex_config=True)
    ...
    write_vertices_to_obj_files(samples, "generated_meshes/")